...
const CarCard = ({ car }) => {
  ...
  return (
    <Card className="min-w-[320px]  rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100">
      {/* Image */}
      ...
      <div className="p-6">
        <div className="flex items-center justify-between">
          ...
          <span className="text-sm  text-[#004078] px-3 py-1 rounded-full">
            {type}
          </span>
        </div>
