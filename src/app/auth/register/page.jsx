      ...
      <div className="w-full max-w-4xl rounded-2xl backdrop-blur-md border border-white/20 overflow-hidden grid grid-cols-1 md:grid-cols-2">
        ...
        <div>
          <div className="text-center">
            <h2 className="text-2xl font-bold mt-12">Register</h2>
            <p className="text-gray-600">Safe journey with Rentify</p>
          </div>
          <div className="flex  flex-col gap-4 p-6 m-3 rounded ">
            <Form className="space-y-4" onSubmit={onSubmit}>
              <TextField isRequired className="w-full" type="text" name="name">
                <Label>Full Name</Label>
                <Input placeholder="John Doe" />
              </TextField>
              <TextField isRequired className="w-full" type="link" name="photo">
                <Label>Photo</Label>
                <Input placeholder="You photo URL" />
              </TextField>
              <TextField
                isRequired
                name="email"
            ...
            <div className="flex gap-3 justify-center items-center">
              ...
              <p className="whitespace-nowrap text-violet-50">
                Or continue with
              </p>
              <Separator className="w-2/5" />
            </div>
            ...
            <p className="text-center">
              ...
              <Link className="text-[#004078] font-bold" href={"/auth/login"}>
                Sign In
              </Link>
            </p>
          </div>
        ...
        {/* Right Side - Welcome */}
        <div className="hidden md:flex border border-white/20  items-center justify-center flex-col p-14 text-[#753fdb] ">
